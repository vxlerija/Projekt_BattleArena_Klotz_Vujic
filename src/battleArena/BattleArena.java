...
public class BattleArena {
	...
	public void printPlayersStatus() {
		System.out.println(this.player1.getName() + " : \n" + " Status = " + this.player1.getLivingPoints() + "\n special ability active = " + this.player1.specialAbilityActive() 
		+ "\n\n " + this.player2.getName() + " : \n" + " Leben = " + this.player2.getLivingPoints() + "\n special ability active = " + this.player2.specialAbilityActive()+ "\n");
	}
}
